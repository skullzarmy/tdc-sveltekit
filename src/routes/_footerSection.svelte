<footer class="flex flex-col items-center justify-between px-6 py-4 bg-zinc-800 sm:flex-row">
    ...
    <div class="flex -mx-2">
        <a class="mx-2" href="https://twitter.com/skllzarmy" aria-label="Twitter">
            <svg
                class="w-5 h-5 fill-current text-gray-200 hover:text-gray-400"
        ...
        <a class="mx-2" href="https://github.com/skullzarmy" aria-label="Github">
            <svg
                class="w-5 h-5 fill-current text-gray-200 hover:text-gray-400"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
